...
package xutil.library.db.table;

import android.text.TextUtils;
import xutil.library.db.annotation.*;
import xutil.library.db.annotation.Column;
import xutil.library.db.annotation.Finder;
import xutil.library.db.annotation.Foreign;
import xutil.library.db.annotation.Id;
import xutil.library.db.converter.ColumnConverter;
import xutil.library.db.converter.ColumnConverterFactory;
import xutil.library.db.sqlite.FinderLazyLoader;
import xutil.library.db.sqlite.ForeignLazyLoader;
import xutil.library.util.LogUtils;
...
public class ColumnUtils {
    ...
    public static Class<?> getForeignEntityType(xutil.library.db.table.Foreign foreignColumn) {
    ...
    @SuppressWarnings("unchecked")
    public static Class<?> getFinderTargetEntityType(xutil.library.db.table.Finder finderColumn) {
