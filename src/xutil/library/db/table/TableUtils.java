...
import xutil.library.db.annotation.Table;
...
public class TableUtils {
     ...
     * key: entityType.name
     */
    private static ConcurrentHashMap<String, xutil.library.db.table.Id> entityIdMap = new ConcurrentHashMap<String, xutil.library.db.table.Id>();

    /* package */
    static synchronized xutil.library.db.table.Id getId(Class<?> entityType) {
        ...
        xutil.library.db.table.Id id = new xutil.library.db.table.Id(entityType, primaryKeyField);
        entityIdMap.put(entityType.getName(), id);
        return id;
    }

    private static String getPrimaryKeyFieldName(Class<?> entityType) {
        xutil.library.db.table.Id id = getId(entityType);
